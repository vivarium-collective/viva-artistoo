...
Run from anywhere with the workspace's virtualenv, e.g.:
    .venv/bin/python glazier-graner-sorting.py
...
# # Reproducing Glazier & Graner (1993) differential-adhesion cell sorting
#
# _Investigation `glazier-graner-sorting` — coder reproduction notebook._
#
# **Question.** Does the pbg-artistoo wrapper over the Artistoo Cellular Potts Model reproduce the
# differential-adhesion-driven rearrangements of Glazier & Graner (1993) — cell sorting /
# engulfment (Fig 12), checkerboard intercalation (Fig 7), and the high-temperature mixing
# transition (Fig 9) — from the paper's own surface-tension energies, with no cell motility?
#
# A reproduction study: run the paper's own surface-tension energies through the real Artistoo
# CPM (wrapped as pbg-artistoo) and check that the heterotypic boundary fraction moves the way
# Glazier & Graner (1993) reported for three regimes.
#
# ---
#
...
if REPO is None and Path('/home/runner/work/viva-artistoo/viva-artistoo').is_dir():
    REPO = Path('/home/runner/work/viva-artistoo/viva-artistoo')
if REPO is None:
    REPO = Path.cwd()
...
# ## Study: `gg-01-differential-adhesion-sorting`
#
# _study.yaml not found — skipped._

# ## Study: `gg-02-sign-and-temperature-controls`
#
# _study.yaml not found — skipped._
